...
*   **Anti-Hallucination**: Strictly controls `/check-api` output to prevent AI from fabricating non-existent APIs.
...
*   **`/check-api <ClassName>`**: Query detailed information about a UE5 class or method.
